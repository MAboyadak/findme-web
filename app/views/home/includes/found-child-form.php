<div class="row" >
        <div class="col-sm-12 hidden add-child-form" id="found-child-form">
            <form action="http://www.findme.com/home/addfound" method="post" enctype='multipart/form-data'>  
                <h3 class="bg-secondary">Add Found Child :</h3>
                <div class="row"> 
